...
\author{David~R.~Rodriguez$^1$, Kelle~Cruz${^2,2.5, 7}$, W.~J.~Cooper$^{3,3.5}$, Niall~Whiteford$^4$, Clemence~Fontanive$^5$, 
...
\affil{$^2.5$American Museum of Natural History, New York, NY, USA}
\affil{$^7$Flatiron Institute, New York, NY, USA}
\affil{$^3$Centre for Astrophysics Research, University of Hertfordshire, Hatfield AL10 9AB, UK}
\affil{$3.5$Istituto Nazionale di Astrofisica, Osservatorio Astrofisico di Torino, Strada Osservatorio 20, I-10025 Pino Torinese 24118, IT}
